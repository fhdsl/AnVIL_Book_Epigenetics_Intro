...
ottrpal::include_slide("https://docs.google.com/presentation/d/1B7y_jm8GuHZMUvTU1TFdW4nqQQV6nOT9XuFwgSflXz4/edit#slide=id.g152864d54a7_1_26")
```

The **NHLF** cell line consists of lung fibroblasts.

```{r, fig.align='center', echo = FALSE, fig.alt= "The table of statistics on NHLF cell line.", out.width = '100%'}
ottrpal::include_slide("https://docs.google.com/presentation/d/1B7y_jm8GuHZMUvTU1TFdW4nqQQV6nOT9XuFwgSflXz4/edit#slide=id.g152864d54a7_1_29")
```
</div>